...
public class ProgressLayout extends RelativeLayout {
    ...
    private void init(AttributeSet attrs) {
        ...
        int errorColor = a.getColor(R.styleable.ProgressLayout_errorColor, Color.BLACK);
        boolean progress = a.getBoolean(R.styleable.ProgressLayout_progress_progress, false);
        a.recycle();
