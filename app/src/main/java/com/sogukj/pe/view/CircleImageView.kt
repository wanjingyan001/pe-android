...
//                color = COLORS[(Math.random() * (COLORS.size - 1)).toInt()]
            ...
            canvas.drawCircle(width / 2.0f, height / 2.0f, fontSize.toFloat(), textPaint)
    ...
    companion object {
        ...
        val COLORS = intArrayOf(0xff44bb66.toInt(), 0xff55ccdd.toInt(), 0xffbb7733.toInt(), 0xffff6655.toInt(), 0xffffbb44.toInt(), 0xff44aaff.toInt())
        private val SCALE_TYPE = ImageView.ScaleType.CENTER
