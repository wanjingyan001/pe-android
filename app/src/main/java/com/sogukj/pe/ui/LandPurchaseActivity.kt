...
class LandPurchaseActivity : ToolbarActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        adapter = RecyclerAdapter<LandPurchaseBean>(this, { _adapter, parent, type ->
            val convertView = _adapter.getView(R.layout.item_project_land_purchase, parent) as View
            object : RecyclerHolder<LandPurchaseBean>(convertView) {
                val tvElecSupervisorNo = convertView.findViewById(R.id.tv_elecSupervisorNo) as TextView
                val tvSignedDate = convertView.findViewById(R.id.tv_signedDate) as TextView
                val tvLocation = convertView.findViewById(R.id.tv_location) as TextView
