...
class FinanceEventListFragment : BaseFragment() {
    ...
    override fun onViewCreated(view: View?, savedInstanceState: Bundle?) {
        ...
        adapter = RecyclerAdapter<InvestEventBean>(baseActivity!!, { _adapter, parent, type ->
            val convertView = _adapter.getView(R.layout.item_project_finance_event, parent) as View
            object : RecyclerHolder<InvestEventBean>(convertView) {
                ...
                val tvFinance = convertView.findViewById(R.id.tv_finance) as TextView
                val tvLunci = convertView.findViewById(R.id.tv_lunci) as TextView
