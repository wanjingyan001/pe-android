 ...
 */
class ICPListActivity : ToolbarActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        adapter = RecyclerAdapter<IcpBean>(this, { _adapter, parent, type ->
            ...
            object : RecyclerHolder<IcpBean>(convertView) {
                ...
                val tvWebName = convertView.findViewById(R.id.tv_webName) as TextView
                val tvCheckDate = convertView.findViewById(R.id.tv_checkDate) as TextView
                val tvWebSite = convertView.findViewById(R.id.tv_webSite) as TextView
                val tvLiscense = convertView.findViewById(R.id.tv_liscense) as TextView
                val tvExamineDate = convertView.findViewById(R.id.tv_examineDate) as TextView
                val tvCompanyType = convertView.findViewById(R.id.tv_companyType) as TextView
