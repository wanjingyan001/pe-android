...
import com.sogukj.pe.ui.partyBuild.PartyMainActivity.Companion.ARTICLE
import com.sogukj.pe.ui.partyBuild.PartyMainActivity.Companion.FILE
...
class PartyListFragment : BaseFragment() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (arguments != null) {
            tid = arguments.getInt(tabId)
            title = arguments.getString(tabTitle)
            bannerUrl = arguments.getString(tabUrl)
        }
    }
