package com.sogukj.pe.ui.IM.location.activity;
...
import com.sogukj.pe.ui.IM.location.adapter.IconListAdapter;
import com.sogukj.pe.ui.IM.location.helper.MapHelper;
...
public class NavigationAmapActivity extends UI implements
    ...
    private void doNavigate(final NimLocation origin, final NimLocation des) {
        List<IconListAdapter.IconListItem> items = new ArrayList<>();
